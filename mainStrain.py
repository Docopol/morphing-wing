...
# strain data 1
plt.subplot(2, 2, 1)
plt.plot(femNodeLocation[1 - 1], femStrainData1s[1 - 1][2:, 4], label="loadstep 1.1")
plt.plot(femNodeLocation[2 - 1], femStrainData1s[2 - 1][2:, 4], label="loadstep 2.1")
plt.plot(femNodeLocation[3 - 1], femStrainData1s[3 - 1][2:, 4], label="loadstep 3.1")
plt.plot(femNodeLocation[4 - 1], femStrainData1s[4 - 1][2:, 4], label="loadstep 4.1")
plt.plot(femNodeLocation[5 - 1], femStrainData1s[5 - 1][2:, 4], label="loadstep 5.1")
plt.legend()

# strain data 2
plt.subplot(2, 2, 2)
plt.plot(femNodeLocation[1 - 1], femStrainData2s[1 - 1][2:, 4], label="loadstep 1.2")
plt.plot(femNodeLocation[2 - 1], femStrainData2s[2 - 1][2:, 4], label="loadstep 2.2")
plt.plot(femNodeLocation[3 - 1], femStrainData2s[3 - 1][2:, 4], label="loadstep 3.2")
plt.plot(femNodeLocation[4 - 1], femStrainData2s[4 - 1][2:, 4], label="loadstep 4.2")
plt.plot(femNodeLocation[5 - 1], femStrainData2s[5 - 1][2:, 4], label="loadstep 5.2")
plt.legend()
